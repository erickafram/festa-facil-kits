...
export const CategoriesSection = () => {
  return (
    <section id="categorias" className="py-12 sm:py-16 bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/20 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-8">
          {categories.map((category, index) => (
            <Card
              key={index}
              className="group relative overflow-hidden hover:shadow-elegant transition-all duration-700 transform hover:-translate-y-4 border-0 bg-gradient-card backdrop-blur-sm min-h-[420px] flex flex-col"
            ...
            >
              ...
              <CardContent className="p-6 space-y-4 relative z-10 flex flex-col justify-between h-full">
                ...
                <div className="text-center py-3">
                  <div className="text-xl font-bold text-primary group-hover:scale-110 transition-transform duration-300">
                    R$ {category.price}
                  </div>
                  ...
                  <ul className="space-y-2 mb-4">
                    {category.features.map((feature, idx) => (
                      <li key={idx} className="flex items-center text-xs text-muted-foreground group-hover:text-foreground transition-colors duration-300">
                        <div className="w-4 h-4 bg-gradient-primary rounded-full flex items-center justify-center mr-2 shadow-soft">
